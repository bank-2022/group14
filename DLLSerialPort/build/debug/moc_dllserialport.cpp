...
QT_MOC_LITERAL(1, 14, 18), // "dllSerialPortReady"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 18) // "serialReadingReady"

    },
    "DLLSerialPort\0dllSerialPortReady\0\0"
    "serialReadingReady"
};
...
void DLLSerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dllSerialPortReady(); break;
        case 1: _t->serialReadingReady(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DLLSerialPort::dllSerialPortReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DLLSerialPort::dllSerialPortReady()
{
